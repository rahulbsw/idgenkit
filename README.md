...
|---|---|---|---|---|---|---|---|---|---|
| C core | 68 | 23 | 18 | 92 | 73 | 23 | 68 | 244 | 134 |
| Rust | 70 | 33 | 9 | 77 | 73 | 33 | 115 | 244 | 139 |
| Go | 123 | 46 | 15 | 267 | 120 | 50 | 156 | 244 | 285 |
| Java 24 | 240 | 31 | 36 | 141 | 248 | 28 | 245 | 244 | 231 |
| Python 3.12 | 1,260 | 408 | 2,451 | 1,820 | 1,749 | 868 | 1,520 | 405 | 1,205 |
...
|---|---|---|---|---|---|---|---|---|---|
| PostgreSQL 17 (ns per row) | 81 | 43 | 63 | 63 | 24 | 85 | 197 | 119 | `gen_random_uuid()` 551 |
| MySQL 9.2 (ns per call) | 112 | 69 | — | 133 | 77 | 159 | 281 | 218 | `UUID()` 72 |
| Redis 8.4 (requests/s) | 571k | 519k | — | 466k | 545k | 557k | 531k | 542k | `PING` 573k |
