...
DROP FUNCTION IF EXISTS relid_generate;
DROP FUNCTION IF EXISTS relid_generate_monotonic;
DROP FUNCTION IF EXISTS relid_tag;
DROP FUNCTION IF EXISTS relid_timestamp;
